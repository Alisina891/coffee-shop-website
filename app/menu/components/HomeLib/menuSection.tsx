              ...
              <div className=" md:w-1/2 max-md:py-10 md:h-[390px] lg:h-[430px]  flex  bg-stone-400 items-center justify-center flex-col text-center max-md:w-full">
                  ...
                  <FadeInItem delay={0.5}>
                    <p className=" mt-5 text-gray-700 text-sm  max-w-[300px]">
                      A seasonal à la carte experience crafted from Australia’s freshest ingredients — a true celebration of local flavours.
                   </p>
                  </FadeInItem>
                  <FadeInItem delay={1}>
                   <button 
                   onClick={handleClick}
                   className="text-amber-700 pb-6 mb-5 pt-10  border-b border-amber-700 w-[150px] h-7  rounded hover:text-gray-600 hover:border-gray-600 transition-all duration-300 text-sm ">VIEW MENU</button>
                   </FadeInItem>
              </div>
              <Image
